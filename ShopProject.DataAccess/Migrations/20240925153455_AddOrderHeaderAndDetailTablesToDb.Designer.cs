...
namespace ShopProject.DataAccess.Migrations
{
    ...
    [Migration("20240925153455_AddOrderHeaderAndDetailTablesToDb")]
    partial class AddOrderHeaderAndDetailTablesToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopProject.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopProject.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopProject.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopProject.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ShopProject.Models.OrderDetail", b =>
                {
                    b.HasOne("ShopProject.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopProject.Models.OrderHeader", b =>
                {
                    b.HasOne("ShopProject.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopProject.Models.ApplicationUser", b =>
                {
                    b.HasOne("ShopProject.Models.Company", "Company")
                        .WithMany()
